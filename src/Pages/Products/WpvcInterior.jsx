        ...
        return (
          <div className="w-full min-h-screen bg-neutral-50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 w-full max-w-6xl px-4">
                      {products.map((product, index) => (
                          <div key={index} className="relative flex justify-center">
                              {/* Product Card */}
                              <div
                                  className="border p-3 shadow-lg bg-gray-600 w-64 md:w-full rounded-md flex flex-col items-center cursor-pointer"
              ...
              {selectedProduct && (
                  ...
                  >
                      <div className="bg-white w-[300px] md:w-[500px] p-4 md:p-6 rounded-lg shadow-4xl border relative">
                          <button
                          ...
                          <img src={selectedProduct.zoomImage} alt="Large Product" className="w-full h-auto object-cover transition-transform duration-300 scale-105" />
                          <div className="flex flex-col sm:flex-row items-center sm:items-start mt-6 montserrat  ">
                              <img src={AdhamsWhite} alt="Large Product" className="md:w-auto md:h-[50px] md:mt-5 h-[50px] w-auto object-cover" />
                              <div className="ml-4 text-center sm:text-left">
                                  <h1 className="text-lg font-semibold">{selectedProduct.content}</h1>
                                  <h1>Interior Wall and Ceiling </h1>
